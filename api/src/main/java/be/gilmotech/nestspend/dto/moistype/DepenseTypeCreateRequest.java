...
/**
 * DTO de requête pour la création d'une dépense type.
 */
@Schema(description = "Requête de création d'une dépense type")
public record DepenseTypeCreateRequest(

        @NotNull(message = "L'identifiant du mois type est obligatoire")
        @Schema(description = "UUID du mois type auquel rattacher cette dépense",
